...
const pokemonNames = ['Unknown', 'Bulbasaur', 'Ivysaur', 'Venusaur', 'Charmander', 'Charmeleon', 'Charizard', 'Squirtle',
...
export default getPokemon = (pokemonId) => {

  return {
    name: pokemonNames[pokemonId],
    image: pokeLogos[pokemonId]
  };
